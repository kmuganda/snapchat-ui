...
export default class CameraComponent extends React.Component {
  ...
  render() {
    ...
    const { hasCameraPermission } = this.setState
      ...
      return (
        <View style={{flex: 1}}>
          ...
          type={this.state.type} >
            ...
            >
              <View style={{flexDirection: 'row', flex: 4}}>
                ...
                <Item style={{backgroundColor:'transparent'}}>
                  ...
                  fontSize: 24, fontWeight: 'bold'}}></Icon>
                  <Input
                    placeholder="Search"
            ...
            'space-between', paddingHorizontal: 10, marginBottom: 15,
            alignItems: 'flex-end'}}>
              ...
              <View style={{alignItems: 'center'}}>
                ...
                <Icon name="ios-images" style={{color: 'white',
                fontSize: 36}}/>
              </View>
